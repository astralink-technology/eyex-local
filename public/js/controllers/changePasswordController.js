...
angular.module('eyexApp.changePasswordController', []).
  controller('changePasswordController', ['$scope', '$http', 'validationServices', function ($scope, $http, validationServices) {
        ...
        $scope.changePassword = function(){
            ...
            var confirmPasswordValidation = validationServices.validateRequiredSimilarField(confirmPassword, true, null, newPassword, 'New passwords does not match');
